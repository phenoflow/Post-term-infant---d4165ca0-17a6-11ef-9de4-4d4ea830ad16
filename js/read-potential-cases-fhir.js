...
(async () => {
  ...
  await fs.writeFile("post-term-infant-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("post-term-infant-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
